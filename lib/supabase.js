...
// ============================================================================
// LOGIN GATE TOGGLE
// Flip this to true once the whole sales team has accounts created in the
// Supabase dashboard. Until then, the tool runs in the original public-access
// mode while the backend is staged and ready.
// ============================================================================
window.ZK_REQUIRE_AUTH = false;
